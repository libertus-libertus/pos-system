      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-sm-12">
                <a href="{{ route('supplier.create') }}" class="btn btn-primary btn-xs btn-flat">
                  <i class="fa fa-plus-circle"> Tambah Supplier</i>
                </a>
              </div>
            </div>
                  ...
                  <tr class="even">
                    ...
                    <td class="text-center">
                      <form class="btn-group" onsubmit="return confirm('Apakah Anda Yakin ?');"
                        ...
                        <a href="{{ route('supplier.edit', $item->id) }}" class="btn btn-sm btn-primary btn-xs btn-flat">
