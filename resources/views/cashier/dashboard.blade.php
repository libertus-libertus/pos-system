    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <a href="{{ route('supplier.index') }}" class="text-black">
                <i class="fa fa-long-arrow-right"></i>
                View Details
            </a>
          </div>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <a href="{{ route('category.index') }}" class="text-black">
                <i class="fa fa-long-arrow-right"></i>
                View Details
            </a>
          </div>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <a href="{{ route('customer.index') }}" class="text-black">
                <i class="fa fa-long-arrow-right"></i>
                View Details
            </a>
          </div>
